...
let
  cfg = config.services.expressvpn_qt;
  expressvpn = pkgs.callPackage ../pkgs/expressvpn_qt.nix {};
in {
  options.services.expressvpn_qt = {
    enable = lib.mkEnableOption "ExpressVPN daemon";
  };
